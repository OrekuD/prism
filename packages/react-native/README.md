...
React Native SDK for [Prism](https://prism-analytics-docs.vercel.app) — Expo + bare, Hermes, offline queue, app sessions, screen views, and error tracking.
...
- [React Native — support matrix & ingestion](https://prism-analytics-docs.vercel.app/docs/reference/sdk-api-and-limits)
- [Installing Prism self-hosted](https://prism-analytics-docs.vercel.app/docs/self-hosting/install-prism)
