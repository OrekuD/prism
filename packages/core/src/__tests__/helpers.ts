import { createPrismClient, type PrismRequest, type PrismResponse, type PrismRuntimeAdapter } from "../index";
...
export function memoryStorage(stored: Map<string, string>): PrismRuntimeAdapter["storage"] {
  return {
