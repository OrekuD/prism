...
export const ConfirmEmail = ({ name, confirmEmailLink }: ConfirmEmailProps) => {
  return (
    <Html>
      <Head />
      <Body style={main}>
        <Container style={container}>
          ...
          <Section>
            ...
            <Text style={text}>
              You recently updated the email address associated with your Prism
              account. Please confirm your new email address.
            </Text>
