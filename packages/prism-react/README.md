...
React hooks and provider for [Prism](https://prism-analytics.vercel.app). Thin layer over `@prism-analytics/browser` — the provider accepts an already-created browser client, so ownership stays outside React.
...
- [React SDK](https://prism-analytics.vercel.app/docs/start/react-sdk)
