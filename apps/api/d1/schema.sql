...
CREATE TABLE IF NOT EXISTS sessions(id INTEGER PRIMARY KEY, project_id TEXT, referrer TEXT, country_code TEXT, os TEXT, browser TEXT, location TEXT, is_mobile INTEGER, created_at DATETIME DEFAULT CURRENT_TIMESTAMP);
